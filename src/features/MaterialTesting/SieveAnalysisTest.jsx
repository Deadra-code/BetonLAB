...
import { Loader2, SlidersHorizontal } from 'lucide-react'; // PENINGKATAN: Import ikon
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="max-w-4xl">
                <DialogHeader>
                    <DialogTitle>Pengujian Analisis Saringan Baru</DialogTitle>
                    <DialogDescription>
                        Masukkan berat sampel awal dan berat yang tertahan di setiap saringan untuk menghitung hasilnya.
                    </DialogDescription>
                </DialogHeader>
